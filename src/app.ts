...
class ProjectItem extends Component<HTMLUListElement, HTMLLIElement> implements Draggable {
  ...
  get persons() {
    return this.project.people ? '1 person' : `${this.project.people} persons`;
  }
...
// ProjectList Class
class ProjectList extends Component<HTMLDivElement, HTMLElement> implements DragTargetable {
...
class ProjectInput extends Component<HTMLDivElement, HTMLFormElement> {
  ...
  private gatherUserInput(): [string, string, number] | void {
    ...
    if (!validate(titleValidatable)) {
      alert('Title input invalid, please try again!');
      return;
    } else if (!validate(descriptionValidatable)) {
      alert('Description input invalid, please try again!');
      return;
    } else if (!validate(peopleValidatable)) {
      alert('People quantity input invalid, please try again!');
      return;
    } else {
